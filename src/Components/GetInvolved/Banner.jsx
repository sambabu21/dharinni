...
export default function Banner(){
    return(
        <div class=" relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8 flex justify-center items-center h-[70vh]">
            ...
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl "> Get Involved </h2>
                {/* <p class="mt-6 text-lg leading-8 text-gray-300">Dharinni {'>'} Get Involved </p> */}
            </div>
        </div>
